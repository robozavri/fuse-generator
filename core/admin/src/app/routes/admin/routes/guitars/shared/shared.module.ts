...
import { GuitarModalComponent } from './modals/modal/guitar-modal.component';
...
@NgModule({
   ...
   declarations: [FormComponent, GuitarModalComponent],
   entryComponents: [GuitarModalComponent, ConfirmDeleteModalComponent],
})
