...
export function referenceBuilder(key) {
  const selectType = refFields[key].referenceType === 'single' ? "''" : '[]';
    return {
        ...
        modalComponentClassConstructorArtumentsArea: generateConstructorArgument(key),
        ...
        listComponentClassConstructorArtumentsArea: generateConstructorArgument(key),
        listformComponentBindParams: generateBindParams(key)
    }
}
